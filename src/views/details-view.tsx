...
const downloadSC = (e : any) => {
    ...
    //     redirect: 'follow'
    // };
    fetch(`http://${window.location.hostname}:8080/fabric/dashboard/downloadCC?name=${name}`,{method: 'GET'})
...
const installSC = (source: any) => {
    ...
    fetch(`http://${window.location.hostname}:8080/fabric/dashboard/deployCC`, requestOptions)
...
const fetchAssets = async () => {
    ...
    let res = new Object();
    let data = fetch(`http://${window.location.hostname}:8080/fabric/dashboard/smart-contracts/asset`, requestOptions)
